...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/kausar
```

A live public deployment of this template is available at [https://kausar.templates.workers.dev](https://kausar.templates.workers.dev)
